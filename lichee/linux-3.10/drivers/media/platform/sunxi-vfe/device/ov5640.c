...
static int sensor_power(struct v4l2_subdev *sd, int on)
{
	...
	case CSI_SUBDEV_PWR_ON:
		...
		vfe_gpio_write(sd,PWDN,CSI_GPIO_LOW);
#endif
		vfe_gpio_set_status(sd,IOVDD_EN,1);
		vfe_gpio_set_status(sd,AVDD_EN,1);
		vfe_gpio_set_status(sd,DVDD_EN,1);
		vfe_gpio_set_status(sd,AFVDD_EN,1);
		vfe_gpio_write(sd,IOVDD_EN,CSI_GPIO_HIGH);
		vfe_gpio_write(sd,AVDD_EN,CSI_GPIO_HIGH);
		vfe_gpio_write(sd,DVDD_EN,CSI_GPIO_HIGH);
		vfe_gpio_write(sd,AFVDD_EN,CSI_GPIO_HIGH);
...
#endif
		vfe_gpio_write(sd,AFVDD_EN,CSI_GPIO_LOW);
		vfe_gpio_write(sd,DVDD_EN,CSI_GPIO_LOW);
		vfe_gpio_write(sd,AVDD_EN,CSI_GPIO_LOW);
		vfe_gpio_write(sd,IOVDD_EN,CSI_GPIO_LOW);
		vfe_gpio_set_status(sd,AFVDD_EN,0);
		vfe_gpio_set_status(sd,DVDD_EN,0);
		vfe_gpio_set_status(sd,AVDD_EN,0);
		vfe_gpio_set_status(sd,IOVDD_EN,0);
